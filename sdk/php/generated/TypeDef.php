...
class TypeDef extends Client\AbstractObject implements Client\IdAble, Node
{
    ...
    public function asEnum(): ?EnumTypeDef
    {
        ...
        return $this->client->loadObjectFromId(\Dagger\EnumTypeDef::class, new \Dagger\Id((string)$id));
    }
    ...
    public function asInput(): ?InputTypeDef
    {
        ...
        return $this->client->loadObjectFromId(\Dagger\InputTypeDef::class, new \Dagger\Id((string)$id));
    }
    ...
    public function asInterface(): ?InterfaceTypeDef
    {
        ...
        return $this->client->loadObjectFromId(\Dagger\InterfaceTypeDef::class, new \Dagger\Id((string)$id));
    }
    ...
    public function asList(): ?ListTypeDef
    {
        ...
        return $this->client->loadObjectFromId(\Dagger\ListTypeDef::class, new \Dagger\Id((string)$id));
    }
    ...
    public function asObject(): ?ObjectTypeDef
    {
        ...
        return $this->client->loadObjectFromId(\Dagger\ObjectTypeDef::class, new \Dagger\Id((string)$id));
    }
    ...
    public function asScalar(): ?ScalarTypeDef
    {
        ...
        return $this->client->loadObjectFromId(\Dagger\ScalarTypeDef::class, new \Dagger\Id((string)$id));
    }
