...
class ObjectTypeDef extends Client\AbstractObject implements Client\IdAble, Node
{
    ...
    public function constructor(): ?Function_
    {
        ...
        return $this->client->loadObjectFromId(\Dagger\Function_::class, new \Dagger\Id((string)$id));
    }
    ...
    public function sourceMap(): ?SourceMap
    {
        ...
        return $this->client->loadObjectFromId(\Dagger\SourceMap::class, new \Dagger\Id((string)$id));
    }
